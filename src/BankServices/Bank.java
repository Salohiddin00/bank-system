...
public class Bank {
    ...
    private MyArrayList allAccounts;
    private MyArrayList zeroAccounts;
    private MyArrayList accountsByBalance;
    private MyArrayList numberHigher;
